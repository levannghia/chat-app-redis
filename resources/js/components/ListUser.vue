        ...
        <div class="card-body contacts_body">
            <div class="contacts">
                <li v-for="user in filteredUsersList" :key="user.id" @click="emit('selectReceiver', user)">
                    <div class="current-user-mark" v-if="user.id === auth.id" />
                    <div class="d-flex bd-highlight">
                        <div class="img_cont">
                            <img :src="user.id === auth.id ? '/images/current_user.jpg' : '/images/other_user.jpg'"
...
const emit = defineEmits(['selectReceiver'])
const auth = ref(window.__app__.user);
